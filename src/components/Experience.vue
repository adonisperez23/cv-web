    ...
    <div class="margin-y">
      ...
      <div class="container">
        <p>
          ...
          Sabores. La aplicacion permite a los clientes del restaurant visualizar el menu actualizado con imagenes de
          los platos y poder realizar pedidos con servicio delivery
          especificando
          detalladamente los
          contornos de su preferencia.
        </p>
        <span>Enlace de la app-web:</span>
      ...
      <div class="container margin-y">
        <li>
          Repositorio del proyecto frontend: <a href="https://github.com/adonisperez23/restaurant-app-frontend"
            target="_blank">https://github.com/adonisperez23/restaurant-app-frontend</a>
        </li>
        <li>
          Repositorio del proyecto backend: <a href="https://github.com/adonisperez23/node-express-server"
            target="_blank">https://github.com/adonisperez23/node-express-server</a>
        </li>
      </div>
